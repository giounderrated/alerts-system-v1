...
<body>
    ...
    <div align="center">
    <button type="button" class="btn btn-primary" onclick="MostrarReportes()">Reportes</button>
    <button type="button" class="btn btn-primary" onclick="MostrarProfesores()">Profesores</button>
    <button type="button" class="btn btn-primary" onclick="MostrarTutores()">Tutores</button>
    </div>
